...
public partial class App : Application
{
    ...
    public App(BaseRepository<UserModel> user, BaseRepository<CPUModel> cpu, BaseRepository<RAMModel> ram, 
        BaseRepository<StorageModel> storage, BaseRepository<CheckoutModel> checkout, BaseRepository<MonitorModel> monitor)
	{
		InitializeComponent();
